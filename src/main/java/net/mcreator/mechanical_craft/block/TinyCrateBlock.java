...
import net.mcreator.mechanical_craft.gui.TinyCrateGuiGui;
...
public class TinyCrateBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:tiny_crate")
	public static final Block block = null;
	@ObjectHolder("mechanical_craft:tiny_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public TinyCrateBlock(MechanicalCraftModElements instance) {
		super(instance, 18);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("tiny_crate"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Tiny Crate");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new TinyCrateGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("tiny_crate");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new TinyCrateGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
