...
import net.mcreator.mechanical_craft.procedures.RubbertreesaplingUpdateTickProcedure;
import net.mcreator.mechanical_craft.procedures.Bonemeal_Rubber_TreeProcedure;
...
public class RubbertreesaplingBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:rubbertreesapling")
	public static final Block block = null;
	public RubbertreesaplingBlock(MechanicalCraftModElements instance) {
		super(instance, 11);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			event.getRegistry().register(feature.setRegistryName("rubbertreesapling"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mechanical_craft:rubbertreesapling"), configuredFeature);
		}
	}
	@SubscribeEvent
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			...
			setRegistryName("rubbertreesapling");
		}
		...
		public void tick(BlockState state, ServerWorld world, BlockPos pos, Random random) {
			...
			int z = pos.getZ();
			{
				...
				RubbertreesaplingUpdateTickProcedure.executeProcedure($_dependencies);
			}
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				$_dependencies.put("z", z);
				$_dependencies.put("world", world);
				Bonemeal_Rubber_TreeProcedure.executeProcedure($_dependencies);
			}
