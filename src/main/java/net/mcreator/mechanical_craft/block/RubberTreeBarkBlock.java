...
import net.mcreator.mechanical_craft.procedures.RubbertreewoodOnBlockRightClickedProcedure;
...
public class RubberTreeBarkBlock extends MechanicalCraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("rubber_tree_bark");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubberTreeBarkBlock.block, (int) (1)));
		}
		...
		public ActionResultType onBlockActivated(BlockState state, World world, BlockPos pos, PlayerEntity entity, Hand hand,
			...
			Direction direction = hit.getFace();
			{
				...
				RubbertreewoodOnBlockRightClickedProcedure.executeProcedure($_dependencies);
			}
