...
public class CopperOreBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(MechanicalCraftModElements instance) {
		super(instance, 6);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mechanical_craft:copper_ore_match"),
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mechanical_craft:copper_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
