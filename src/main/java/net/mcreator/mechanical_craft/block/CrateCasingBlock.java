...
public class CrateCasingBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:crate_casing")
	public static final Block block = null;
	public CrateCasingBlock(MechanicalCraftModElements instance) {
		super(instance, 17);
	}
