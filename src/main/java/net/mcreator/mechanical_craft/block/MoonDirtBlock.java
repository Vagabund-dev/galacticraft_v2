...
public class MoonDirtBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:moon_dirt")
	public static final Block block = null;
	public MoonDirtBlock(MechanicalCraftModElements instance) {
		super(instance, 2);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("mechanical_craft:moon_dirt_match"),
			...
			feature = new OreFeature(OreFeatureConfig.CODEC) {
				...
				public boolean generate(ISeedReader world, ChunkGenerator generator, Random rand, BlockPos pos, OreFeatureConfig config) {
					...
					if (dimensionType == RegistryKey.getOrCreateKey(Registry.WORLD_KEY, new ResourceLocation("mechanical_craft:planet_moon")))
			...
			event.getRegistry().register(feature.setRegistryName("moon_dirt"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mechanical_craft:moon_dirt"), configuredFeature);
		}
	}
	@SubscribeEvent
