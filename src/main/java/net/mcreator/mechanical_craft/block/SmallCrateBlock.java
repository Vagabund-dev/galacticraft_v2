...
import net.mcreator.mechanical_craft.gui.SmallCrateGuiGui;
...
public class SmallCrateBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:small_crate")
	public static final Block block = null;
	@ObjectHolder("mechanical_craft:small_crate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public SmallCrateBlock(MechanicalCraftModElements instance) {
		super(instance, 19);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("small_crate"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(TinyCrateBlock.block, (int) (1)));
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Small Crate");
					}

					@Override
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new SmallCrateGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(63, ItemStack.EMPTY);
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("small_crate");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new SmallCrateGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
