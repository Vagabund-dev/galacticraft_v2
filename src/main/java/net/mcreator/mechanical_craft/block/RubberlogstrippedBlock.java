...
public class RubberlogstrippedBlock extends MechanicalCraftModElements.ModElement {
	...
	public static class CustomBlock extends Block {
		...
		public CustomBlock() {
			...
			setRegistryName("rubberlogstripped");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(RubberlogstrippedBlock.block, (int) (1)));
		}
	}
}
