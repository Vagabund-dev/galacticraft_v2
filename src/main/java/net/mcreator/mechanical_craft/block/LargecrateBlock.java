...
import net.mcreator.mechanical_craft.gui.LargeCrateGuiGui;
...
public class LargecrateBlock extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:largecrate")
	public static final Block block = null;
	@ObjectHolder("mechanical_craft:largecrate")
	public static final TileEntityType<CustomTileEntity> tileEntityType = null;
	public LargecrateBlock(MechanicalCraftModElements instance) {
		super(instance, 21);
	...
	private static class TileEntityRegisterHandler {
		...
		public void registerTileEntity(RegistryEvent.Register<TileEntityType<?>> event) {
			event.getRegistry().register(TileEntityType.Builder.create(CustomTileEntity::new, block).build(null).setRegistryName("largecrate"));
		}
	}
	@Override
	@OnlyIn(Dist.CLIENT)
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						return new LargeCrateGuiGui.GuiContainerMod(id, inventory,
	...
	public static class CustomTileEntity extends LockableLootTileEntity implements ISidedInventory {
		private NonNullList<ItemStack> stacks = NonNullList.<ItemStack>withSize(168, ItemStack.EMPTY);
		...
		public ITextComponent getDefaultName() {
			return new StringTextComponent("largecrate");
		}
		...
		public Container createMenu(int id, PlayerInventory player) {
			return new LargeCrateGuiGui.GuiContainerMod(id, player, new PacketBuffer(Unpooled.buffer()).writeBlockPos(this.getPos()));
		}
