...
public class MenuGuiWindow extends ContainerScreen<MenuGui.GuiContainerMod> {
	...
	private static final ResourceLocation texture = new ResourceLocation("mechanical_craft:textures/menu.png");
	@Override
	...
	public void init(Minecraft minecraft, int width, int height) {
		...
		this.addButton(new Button(this.guiLeft + 6, this.guiTop + 8, 50, 20, new StringTextComponent("mìsíc"), e -> {
			if (true) {
				MechanicalCraftMod.PACKET_HANDLER.sendToServer(new MenuGui.ButtonPressedMessage(0, x, y, z));
