...
package net.mcreator.mechanical_craft.item;
...
public class CopperIngotItem extends MechanicalCraftModElements.ModElement {
	@ObjectHolder("mechanical_craft:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(MechanicalCraftModElements instance) {
		super(instance, 7);
	}
