...
package net.mcreator.mechanical_craft.world.dimension;
...
public class PlanetMoonDimension extends MechanicalCraftModElements.ModElement {
	public PlanetMoonDimension(MechanicalCraftModElements instance) {
		super(instance, 10);
	}
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				ObfuscationReflectionHelper.setPrivateValue(WorldCarver.class, WorldCarver.CAVE, new ImmutableSet.Builder<Block>()
						...
						.add(MoonRockBlock.block.getDefaultState().getBlock()).build(), "field_222718_j");
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("mechanical_craft:planet_moon"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
