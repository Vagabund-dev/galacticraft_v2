...
public class OilspawnStructure extends MechanicalCraftModElements.ModElement {
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 100000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("mechanical_craft", "oil_lake"));
							if (template == null)
								return false;
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mechanical_craft:oilspawn"), configuredFeature);
		}
	}
	@SubscribeEvent
