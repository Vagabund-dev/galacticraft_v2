...
package net.mcreator.mechanical_craft.world.structure;
...
import net.mcreator.mechanical_craft.procedures.Rubber_tree_spawnProcedure;
...
public class RubbertreespawnStructure extends MechanicalCraftModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public RubbertreespawnStructure(MechanicalCraftModElements instance) {
		super(instance, 50);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 100000) {
						...
						for (int a = 0; a < count; a++) {
									...
									random);
							{
								...
								Rubber_tree_spawnProcedure.executeProcedure($_dependencies);
							}
						}
					}
					return true;
			...
			event.getRegistry().register(feature.setRegistryName("rubber_tree_spawn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("mechanical_craft:rubber_tree_spawn"), configuredFeature);
		}
	}
	@SubscribeEvent
