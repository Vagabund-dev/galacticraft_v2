...
package net.mcreator.lulw.world.dimension;
...
public class PlanetMoonDimension extends LulwModElements.ModElement {
	public PlanetMoonDimension(LulwModElements instance) {
		super(instance, 6);
	}
	...
	public void clientLoad(FMLClientSetupEvent event) {
		...
		DeferredWorkQueue.runLater(() -> {
			try {
				...
				effectsRegistry.put(new ResourceLocation("lulw:planet_moon"), customEffect);
			} catch (Exception e) {
				e.printStackTrace();
			}
		});
