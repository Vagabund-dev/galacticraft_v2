...
package net.mcreator.lulw.world.structure;
...
public class OilspawnStructure extends LulwModElements.ModElement {
	private static Feature<NoFeatureConfig> feature = null;
	private static ConfiguredFeature<?, ?> configuredFeature = null;
	public OilspawnStructure(LulwModElements instance) {
		super(instance, 14);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
					...
					if ((random.nextInt(1000000) + 1) <= 10000) {
						...
						for (int a = 0; a < count; a++) {
							...
							Template template = world.getWorld().getStructureTemplateManager()
									.getTemplateDefaulted(new ResourceLocation("lulw", "oil_lake"));
							if (template == null)
								return false;
			...
			event.getRegistry().register(feature.setRegistryName("oilspawn"));
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lulw:oilspawn"), configuredFeature);
		}
	}
	@SubscribeEvent
