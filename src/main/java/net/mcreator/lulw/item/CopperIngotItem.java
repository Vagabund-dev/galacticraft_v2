...
package net.mcreator.lulw.item;
...
public class CopperIngotItem extends LulwModElements.ModElement {
	@ObjectHolder("lulw:copper_ingot")
	public static final Item block = null;
	public CopperIngotItem(LulwModElements instance) {
		super(instance, 3);
	}
