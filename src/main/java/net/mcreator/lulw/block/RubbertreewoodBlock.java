...
public class RubbertreewoodBlock extends LulwModElements.ModElement {
	@ObjectHolder("lulw:rubbertreewood")
	public static final Block block = null;
	public RubbertreewoodBlock(LulwModElements instance) {
		super(instance, 18);
	}
