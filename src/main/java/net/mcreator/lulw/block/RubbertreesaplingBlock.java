...
import net.mcreator.lulw.procedures.RubbertreesaplingUpdateTickProcedure;
import net.mcreator.lulw.procedures.Bonemeal_Rubber_TreeProcedure;
...
public class RubbertreesaplingBlock extends LulwModElements.ModElement {
	@ObjectHolder("lulw:rubbertreesapling")
	public static final Block block = null;
	public RubbertreesaplingBlock(LulwModElements instance) {
		super(instance, 19);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lulw:rubbertreesapling"), configuredFeature);
		}
	}
	@SubscribeEvent
