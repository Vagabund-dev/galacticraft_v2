...
public class CopperOreBlock extends LulwModElements.ModElement {
	@ObjectHolder("lulw:copper_ore")
	public static final Block block = null;
	public CopperOreBlock(LulwModElements instance) {
		super(instance, 1);
	...
	private static class FeatureRegisterHandler {
		...
		public void registerFeature(RegistryEvent.Register<Feature<?>> event) {
			CUSTOM_MATCH = Registry.register(Registry.RULE_TEST, new ResourceLocation("lulw:copper_ore_match"), () -> CustomRuleTest.codec);
			...
			Registry.register(WorldGenRegistries.CONFIGURED_FEATURE, new ResourceLocation("lulw:copper_ore"), configuredFeature);
		}
	}
	@SubscribeEvent
